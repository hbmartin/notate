...
import com.alexdremov.notate.navigation.readNotePickerDestination
...
class NotePickerActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val destination = intent.readNotePickerDestination()
        val lockedProjectId = destination.lockedProjectId
        val disabledItemUuid = destination.disabledItemUuid
